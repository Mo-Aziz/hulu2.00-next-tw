...
<div className="flex px-10 sm:px-20 text-2xl whitespace-nowrap space-x-10 sm:space-x-14 overflow-x-scroll scrollbar-hide ">
...
{/* adding shade to the last element on the nav bar */}
<div
